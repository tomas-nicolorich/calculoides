 ...
 * `frontend/src/entities/savings-goal/contributionDiff.ts` (PR 16). Diffs a
 * goal's current DB-backed contribution breakdown against the in-session
 * override intent to derive exactly which members must be upserted vs.
 * deleted on save.
 *
