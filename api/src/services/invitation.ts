...
export const InvitationService = {
   ...
   */
  async createInvitation(groupId: string, inviterId: string, email: string): Promise<InvitationWithDetails & { id: string; status: string; inviterId: string; groupId: string; updatedAt: Date }> {
